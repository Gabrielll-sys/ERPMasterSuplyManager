...
VALUES ('20230803235036_v1', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230804104822_v2', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230805171427_v3', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230807121840_v4', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230808160507_v5', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230811110946_v6', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230819220341_v7', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230824163008_ v8', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230830193848_v9', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230912174901_v10', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230915182050_v11', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20230926111041_v12', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20231010102947_v13', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20231023184719_v14', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20231026161426_v15', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20231104000653_v-16', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20231107210655_v17', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20231130131823_v18', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20231229190900_v19', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240104172716_v20', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240110143111_v21', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240110184440_v22', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240112130542_v23', '7.0.17');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240124124538_v24', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Materiais` ADD `TesteNovaColuna` float NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240217165130_v25', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Materiais` DROP COLUMN `TesteNovaColuna`;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240217172442_v26', '7.0.17');
...
CREATE TABLE `Orcamentos` (
    `Id` int NOT NULL AUTO_INCREMENT,
    `ReponsavelOrcamento` longtext CHARACTER SET utf8mb4 NULL,
...
CREATE TABLE `ItensOrcamento` (
    ...
    `DataAdicaoItem` datetime NOT NULL,
    `MaterialId` int NOT NULL,
    `OrcamentoId` int NOT NULL,
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240302022220_27', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` CHANGE `ReponsavelOrcamento` `ResponsavelOrcamento` longtext NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240302023755_v28', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` ADD `CPFOrCNPJ` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Orcamentos` ADD `EmailCliente` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Orcamentos` ADD `Empresa` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Orcamentos` ADD `Endereço` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Orcamentos` ADD `NomeCliente` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Orcamentos` ADD `Telefone` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240303023452_v29', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` ADD `TipoPagamento` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240303191418_v30', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` CHANGE `Endereço` `Endereco` longtext NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240303220853_v31', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` CHANGE `CPFOrCNPJ` `CpfOrCnpj` longtext NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240303221637_v32', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` ADD `NomeOrcamento` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240304162823_v33', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `ItensOrcamento` ADD `PrecoItemOrcamento` decimal(65,30) NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240304182340_v34', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` ADD `ResponsavelVenda` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240305004800_v35', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Orcamentos` CHANGE `PrecoTotal` `PrecoVendaTotal` decimal(65,30) NULL;

ALTER TABLE `Orcamentos` ADD `PrecoVendaComDesconto` decimal(65,30) NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240306133147_v36', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Usuários` ADD `PerfilUsuario` int NOT NULL DEFAULT 0;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240320183238_v37', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Usuários` MODIFY COLUMN `Senha` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Usuários` MODIFY COLUMN `PerfilUsuario` int NULL;

ALTER TABLE `Usuários` MODIFY COLUMN `Nome` longtext CHARACTER SET utf8mb4 NULL;

ALTER TABLE `Usuários` MODIFY COLUMN `Email` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240320184311_v38', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Usuários` ADD `DataCadastro` datetime NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240328143453_v39', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Usuários` DROP COLUMN `PerfilUsuario`;

ALTER TABLE `Usuários` ADD `Cargo` longtext CHARACTER SET utf8mb4 NOT NULL;

ALTER TABLE `Usuários` ADD `isActive` tinyint(1) NOT NULL DEFAULT FALSE;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240402130342_v40', '7.0.17');
...
CREATE TABLE `LogAcoesUsuarios` (
    ...
    `DataAcao` datetime NULL,
    `Responsavel` longtext CHARACTER SET utf8mb4 NULL,
    CONSTRAINT `PK_LogAcoesUsuarios` PRIMARY KEY (`Id`)
) CHARACTER SET=utf8mb4;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240404233952_v41', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Materiais` ADD `UrlImage` longtext CHARACTER SET utf8mb4 NOT NULL;
...
CREATE TABLE `AtividadesRd` (
    ...
    `Observacoes` longtext CHARACTER SET utf8mb4 NULL,
    `UrlsFotos` longtext CHARACTER SET utf8mb4 NULL,
...
CREATE TABLE `RelatorioDiarios` (
    ...
    `HorarioAbertura` datetime NULL,
    `DataRD` datetime NULL,
    `isFinished` tinyint(1) NULL,
    CONSTRAINT `PK_RelatorioDiarios` PRIMARY KEY (`Id`)
) CHARACTER SET=utf8mb4;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240416002847_v42', '7.0.17');

COMMIT;

START TRANSACTION;

ALTER TABLE `Materiais` MODIFY COLUMN `UrlImage` longtext CHARACTER SET utf8mb4 NULL;

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240416003400_v43', '7.0.17');
