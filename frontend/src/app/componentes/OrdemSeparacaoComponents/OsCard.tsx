  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 flex flex-col transition-shadow hover:shadow-xl">
        ...
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Portal>
            <DropdownMenu.Content className="bg-white dark:bg-gray-800 shadow-lg rounded-md p-1 border dark:border-gray-700 w-48" sideOffset={5}>
              ...
              <DropdownMenu.Item onSelect={() => router.push(`/editando-ordem-separacao/${os.id}`)} className="flex items-center gap-2 px-3 py-2 text-sm rounded-md cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <footer className="p-4 border-t dark:border-gray-700">
        ...
        <button 
          onClick={() => router.push(`/editando-ordem-separacao/${os.id}`)}
