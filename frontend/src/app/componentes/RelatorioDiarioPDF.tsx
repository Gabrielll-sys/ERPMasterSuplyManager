    ...
    <View wrap>
        ...
        <View style={{  width: "90%",  borderStyle: "solid", borderWidth: 1, borderLeftWidth: 1, borderTopWidth: 1,textAlign:"center",alignSelf:"center"}}>
          ...
          <View style={{  margin: "auto", flexDirection: "row" ,backgroundColor:"#EBE2AB"}}>
            ...
            <View style={{  width: "90%",  borderStyle: "solid", borderWidth: 1, borderLeftWidth: 1, borderTopWidth: 1,textAlign:"left",alignSelf:"center"}}>
              <Text style={{fontSize: 12,padding:2,border:"solid"}}>{atividade.numeroAtividade} - {atividade.descricao }</Text>
            </View>
            
            <View style={styles.tableRow}>
              <Text> {atividade.observacoes}</Text>
