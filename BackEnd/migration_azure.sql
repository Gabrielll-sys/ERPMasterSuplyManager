...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260126143400_AddChecklistInspecao') THEN

    CREATE TABLE `ChecklistsInspecao` (
        `Id` int NOT NULL AUTO_INCREMENT,
        `ConteudoJson` longtext CHARACTER SET utf8mb4 NOT NULL,
        `CriadoEm` datetime(6) NOT NULL,
        `AtualizadoEm` datetime(6) NULL,
        CONSTRAINT `PK_ChecklistsInspecao` PRIMARY KEY (`Id`)
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260126143400_AddChecklistInspecao', '8.0.5');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260127111115_AddOptimizationIndices') THEN

    ALTER TABLE `Orcamentos` MODIFY COLUMN `NomeCliente` varchar(255) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Orcamentos` MODIFY COLUMN `CpfOrCnpj` varchar(255) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Materiais` MODIFY COLUMN `Descricao` varchar(255) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Materiais` MODIFY COLUMN `CodigoInterno` varchar(255) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    ALTER TABLE `Materiais` MODIFY COLUMN `CodigoFabricante` varchar(255) CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    CREATE INDEX `IX_Orcamentos_CpfOrCnpj` ON `Orcamentos` (`CpfOrCnpj`);
...
BEGIN
    ...
    CREATE INDEX `IX_Orcamentos_DataOrcamento` ON `Orcamentos` (`DataOrcamento`);
...
BEGIN
    ...
    CREATE INDEX `IX_Orcamentos_NomeCliente` ON `Orcamentos` (`NomeCliente`);
...
BEGIN
    ...
    CREATE INDEX `IX_Materiais_CodigoFabricante` ON `Materiais` (`CodigoFabricante`);
...
BEGIN
    ...
    CREATE INDEX `IX_Materiais_CodigoInterno` ON `Materiais` (`CodigoInterno`);
...
BEGIN
    ...
    CREATE INDEX `IX_Materiais_Descricao` ON `Materiais` (`Descricao`);
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260127111115_AddOptimizationIndices', '8.0.5');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260128214713_AddChecklistInspecaoImagens') THEN

    CREATE TABLE `ChecklistsInspecaoImagens` (
        `Id` int NOT NULL AUTO_INCREMENT,
        `ChecklistInspecaoId` int NOT NULL,
        `ImageUrl` longtext CHARACTER SET utf8mb4 NOT NULL,
        `ImageKey` longtext CHARACTER SET utf8mb4 NOT NULL,
        `CriadoEm` datetime(6) NOT NULL,
        CONSTRAINT `PK_ChecklistsInspecaoImagens` PRIMARY KEY (`Id`),
        CONSTRAINT `FK_ChecklistsInspecaoImagens_ChecklistsInspecao_ChecklistInspec~` FOREIGN KEY (`ChecklistInspecaoId`) REFERENCES `ChecklistsInspecao` (`Id`) ON DELETE CASCADE
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    CREATE INDEX `IX_ChecklistsInspecaoImagens_ChecklistInspecaoId` ON `ChecklistsInspecaoImagens` (`ChecklistInspecaoId`);
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260128214713_AddChecklistInspecaoImagens', '8.0.5');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260130122309_AddAprTipo') THEN

    ALTER TABLE `Aprs` ADD `Tipo` longtext CHARACTER SET utf8mb4 NOT NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260130122309_AddAprTipo', '8.0.5');
...
CREATE PROCEDURE MigrationsScript()
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MigrationId` = '20260130170457_AddAprFechada') THEN

    ALTER TABLE `Aprs` ADD `Fechada` tinyint(1) NOT NULL DEFAULT FALSE;
...
BEGIN
    ...
    ALTER TABLE `Aprs` ADD `FechadaEm` datetime(6) NULL;
...
BEGIN
    ...
    ALTER TABLE `Aprs` ADD `FechadaPor` longtext CHARACTER SET utf8mb4 NULL;
...
BEGIN
    ...
    INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
    VALUES ('20260130170457_AddAprFechada', '8.0.5');
